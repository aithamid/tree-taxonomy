            ...
            input: {
              multi_choice: {
                list: [
                  {
                    id: "1",
                    label: "Roads open to all traffic types (no restriction)",
                  },
            ...
            input: {
              multi_choice: {
                list: [
                  ...
                  {
                    id: "4",
                    label: "Position lights of the other vehicles in lane",
                  },
            ...
            input: {
              multi_choice: {
                list: [
                  ...
                  {
                    id: "10",
                    label: "Signal violation / Intersection safety (SigV)",
                  },
                ],
                value: [],
              },
              ...
              multi_choice: {
                list: [
                  ...
                  { id: "2", label: "Vulnerable Road User protection (VRU)" },
                  {
                    id: "3",
                    label:
                      "Connected and cooperative navigation into and out of the city (CCN)",
                  },
                  {
                    id: "4",
                    label: "Zone Access Control for urban areas (ZAC)",
                  },
                  {
                    id: "5",
                    label: "Cooperative Collision Risk Warning (CCRW)",
                  },
            ...
            input: {
              multi_choice: {
                list: [
                  ...
                  {
                    id: "2",
                    label: "Advanced Pre-crash sensing warning (APCSW)",
                  },
                  {
                    id: "3",
                    label: "Cooperative Adaptive Cruise Control (C-ACC)",
                  },
                  { id: "4", label: "Cooperative ACC String (C-ACC S)" },
                  {
                    id: "5",
                    label: "MotorCycle Approaching warning or protection (MAW)",
                  },
                  { id: "6", label: "Overtaking vehicle warning (OVW)" },
                  {
                    id: "7",
                    label: "Advanced Intersection Collision Warning (AICW)",
                  },
            ...
            input: {
              multi_choice: {
                list: [
                  {
                    id: "1",
                    label: "Advanced Cooperative ACC (String) (ACACC)",
                  },
                  { id: "2", label: "Target Driving Area Reservation (TDAR)" },
                  {
                    id: "3",
                    label: "Transition of control notification (ToCN)",
                  },
                  {
                    id: "4",
                    label: "Improved Vulnerable Road User Protection (IVRUP)",
                  },
                  ...
                  {
                    id: "9",
                    label: "Cooperative ACC string management (CACCS M)",
                  },
                  {
                    id: "10",
                    label: "Cooperative Transition of Control (CToC)",
                  },
                ],
                value: [],
              },
            ...
            input: {
              multi_choice: {
                list: [
                  ...
                  {
                    id: "4",
                    label: "Insertion (on current lane or on insertion lane)",
                  },
                  { id: "5", label: "Temporary road works" },
                  { id: "6", label: "Non-equipped VRU protection" },
                  {
                    id: "7",
                    label: "Localisation of assets and CCAM vehicles",
                  },
